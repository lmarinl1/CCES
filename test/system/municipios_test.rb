...
class MunicipiosTest < ApplicationSystemTestCase
  ...
  test "creating a Municipio" do
    ...
    fill_in "Activo", with: @municipio.activo
    fill_in "Categoria", with: @municipio.categoria
    fill_in "Creador", with: @municipio.creador
    fill_in "Departamento", with: @municipio.departamento
    fill_in "Descripcion", with: @municipio.descripcion
    fill_in "Modificador", with: @municipio.modificador
    fill_in "Nombre", with: @municipio.nombre
    fill_in "Web", with: @municipio.web
